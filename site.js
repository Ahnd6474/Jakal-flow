...
const translations = {
  ko: {
    title: "codex-auto | AI Repo Operations",
    description: "codex-auto는 여러 저장소를 안전하게 관리하고, Codex가 작업을 쪼개고 실행하고 검증하도록 돕는 데스크톱 자동화 앱입니다.",
    nav_product: "제품",
    nav_workflow: "워크플로우",
    nav_release: "릴리즈",
    nav_contact: "문의",
    ...
    hero_text: "codex-auto는 여러 저장소를 하나의 운영 화면에서 다루며, Codex가 일을 쪼개고, 블록 단위로 실행하고, 테스트와 롤백까지 관리하도록 설계된 자동화 앱입니다.",
    hero_docs: "문서 보기",
    hero_contact: "연락하기",
    hero_meta_1: "멀티 저장소",
    hero_meta_2: "엄격한 검증",
    ...
    release_card_2_text: "Tkinter GUI를 바탕으로 실제 운영 화면과 데스크톱 배포 경험을 함께 준비하고 있습니다.",
    ...
    contact_text: "codex-auto를 내부 자동화 도구나 배포 가능한 앱으로 확장하려면 아래 메일로 연락할 수 있습니다.",
    contact_cta: "메일 보내기",
    footer_cookie: "쿠키 설정",
  ...
  en: {
    title: "codex-auto | AI Repo Operations",
    description: "codex-auto is a desktop automation app that manages multiple repositories safely and lets Codex break down, execute, and validate work.",
    nav_product: "Product",
    ...
    hero_text: "codex-auto operates multiple repositories from one surface and is designed so Codex can break work into blocks, execute them, and manage tests and rollbacks.",
    hero_docs: "Docs",
    ...
    release_card_2_text: "Built on a Tkinter GUI while preparing for a more polished desktop distribution experience.",
    ...
    contact_text: "If you want to expand codex-auto into an internal automation tool or a shippable app, reach out by email.",
  ...
  zh: {
    title: "codex-auto | AI 仓库运营",
    description: "codex-auto 是一款桌面自动化应用，可安全管理多个仓库，并让 Codex 拆分、执行和验证工作。",
    nav_product: "产品",
    nav_workflow: "流程",
    nav_release: "发布",
    nav_contact: "联系",
    ...
    hero_text: "codex-auto 在一个界面中管理多个仓库，并让 Codex 拆分任务、按区块执行，同时管理测试与回滚。",
    hero_docs: "文档",
    hero_contact: "联系",
    hero_meta_1: "多仓库",
    hero_meta_2: "严格验证",
    ...
    release_card_2_text: "基于 Tkinter GUI，同时为更完整的桌面分发体验做准备。",
    ...
    contact_text: "如果你希望把 codex-auto 扩展为内部自动化工具或可发布应用，可以通过邮件联系。",
    contact_cta: "发送邮件",
  ...
  ja: {
    title: "codex-auto | AI Repo Operations",
    description: "codex-auto は複数リポジトリを安全に管理し、Codex が作業を分解・実行・検証できるようにするデスクトップ自動化アプリです。",
    nav_product: "製品",
    nav_workflow: "ワークフロー",
    nav_release: "リリース",
    nav_contact: "問い合わせ",
    ...
    hero_text: "codex-auto は複数のリポジトリを一つの運用画面で扱い、Codex が作業を分解し、ブロック単位で実行し、テストとロールバックまで管理できるよう設計された自動化アプリです。",
    hero_docs: "ドキュメント",
    hero_contact: "連絡する",
    ...
    release_card_2_text: "Tkinter GUI を基盤にしつつ、より完成度の高いデスクトップ配布体験を準備しています。",
    ...
    contact_text: "codex-auto を社内自動化ツールや配布可能なアプリへ拡張したい場合は、以下のメールで連絡できます。",
    contact_cta: "メールを送る",
