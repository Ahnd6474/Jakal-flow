...
MODEL_PRESETS: tuple[ModelPreset, ...] = (
    ...
    ModelPreset(
        ...
        model=AUTO_MODEL_SLUG,
        effort="low",
        description="Use automatic routing while keeping reasoning fixed at low only.",
    ),
    ModelPreset(
        preset_id="medium",
        label="Medium Only",
        model=AUTO_MODEL_SLUG,
        effort="medium",
        description="Use automatic routing while keeping reasoning fixed at medium only.",
    ),
    ModelPreset(
        preset_id="high",
        label="High Only",
        model=AUTO_MODEL_SLUG,
        effort="high",
        description="Use automatic routing while keeping reasoning fixed at high only.",
    ),
    ModelPreset(
        preset_id="xhigh",
        label="XHigh Only",
        model=AUTO_MODEL_SLUG,
        effort="xhigh",
        description="Use automatic routing while keeping reasoning fixed at xhigh only.",
    ),
)
