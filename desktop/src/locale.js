...
const STRINGS = {
  en: {
    ...
    "config.advancedModelSettings": "Advanced Model Settings",
    "config.advancedModelSettingsDescription": "Manual model slug and extra prompt controls for advanced workflows.",
    "config.executionModel": "Execution Model",
    "config.fastModeDescription": "When enabled, codex-auto prefixes each Codex prompt with /fast.",
    ...
    "message.projectDeleted": "Project removed from codex-auto.",
    "message.allProjectsDeleted": "All managed projects were removed from codex-auto.",
    ...
    "option.generateWordReport": "Generate Word Report On Finish",
    "option.developerMode": "Enable Developer Mode",
    "option.lightMode": "Use Light Mode",
    ...
    "prompt.confirmDeleteProject": "Remove this project from codex-auto? The managed docs, logs, and state will be deleted, but the original repository folder will stay in place.",
    "prompt.confirmDeleteAllProjects": "Remove all projects from codex-auto? Managed docs, logs, and state will be deleted for every project, but the original repository folders will stay in place.",
    "preset.auto": "Auto",
    ...
    "reports.wordReportDisabled": "Word report generation is disabled for this project.",
    "reports.wordReportReady": "Word report path: {path}",
    ...
    "config.wordReportDescription": "When enabled, codex-auto also generates a .docx report after closeout finishes.",
    ...
    "sidebar.projectContextDelete": "Right-click to delete this project",
  ...
  ko: {
    ...
    "config.advancedModelSettings": "고급 모델 설정",
    "config.advancedModelSettingsDescription": "수동 모델 슬러그와 추가 프롬프트를 직접 제어합니다.",
    "config.executionModel": "실행 모델",
    "config.fastModeDescription": "활성화하면 codex-auto가 각 Codex 프롬프트 앞에 /fast를 붙입니다.",
    ...
    "message.projectDeleted": "codex-auto에서 프로젝트를 제거했습니다.",
    "message.allProjectsDeleted": "codex-auto에서 모든 관리 프로젝트를 제거했습니다.",
    ...
    "option.generateWordReport": "완료 후 Word 보고서 생성",
    "option.developerMode": "개발자 모드 켜기",
    "option.lightMode": "라이트 모드 사용",
    ...
    "prompt.confirmDeleteProject": "이 프로젝트를 codex-auto에서 제거할까요? 관리 중인 문서, 로그, 상태만 삭제되고 원본 저장소 폴더는 그대로 둡니다.",
    "prompt.confirmDeleteAllProjects": "모든 프로젝트를 codex-auto에서 제거할까요? 각 프로젝트의 관리 문서, 로그, 상태는 삭제되지만 원본 저장소 폴더는 그대로 둡니다.",
    "preset.auto": "자동",
    "preset.highOnly": "높음만",
    "preset.lowOnly": "낮음만",
    ...
    "reports.reports": "보고서",
    "reports.wordReportDisabled": "이 프로젝트는 Word 보고서 생성을 사용하지 않습니다.",
    "reports.wordReportReady": "Word 보고서 경로: {path}",
    "run.closeout": "마감",
    "run.done": "완료",
    ...
    "config.wordReportDescription": "활성화하면 closeout이 끝난 뒤 codex-auto가 .docx 보고서도 함께 생성합니다.",
    ...
    "sidebar.projectContextDelete": "이 프로젝트를 삭제하려면 우클릭하세요",
