...
const STRINGS = {
  en: {
    ...
    "config.fastModeDescription": "When enabled, plan generation skips Planner Agent A and uses the compact planning path.",
    ...
    "option.useFastMode": "Compact Planning",
    ...
    "runtime.compactPlanning": "compact planning",
  ...
  ko: {
    ...
    "config.fastModeDescription": "활성화하면 계획 생성에서 Planner Agent A를 건너뛰고 압축 계획 경로를 사용합니다.",
